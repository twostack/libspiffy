...
void main() {
  ...
  group('PostgreSQL Migrations', () {
    test('should run migrations successfully', () async {
      ...
      // v012 merkle proof rejected status
      ...
      expect(applied, hasLength(12));
      expect(applied.first.name, equals('initial_schema'));
      expect(applied.last.name, equals('merkle_proof_rejected_status'));
    });
    ...
    test('v005 rolls back and re-applies with two wallets sharing a txid, an outpoint and a proof',
      ...
      // v012, v011, v010, v009, v008, v007 and v006 first; then v005's down
      // keeps the first-stored row so the global keys can be restored.
